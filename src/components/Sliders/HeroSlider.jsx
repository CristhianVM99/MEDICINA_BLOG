...
const sliderData = [
  {
    id: 1,
    title: "Medicina en la UMSA vs. UPEA: ¿Cuál Elegir?",
    maintitle: "Comparativa",
    desp: "Explora las diferencias en la formación médica entre la Universidad Mayor de San Andrés (UMSA) y la Universidad Pública de El Alto (UPEA). Comparamos la calidad académica, infraestructura y oportunidades para los futuros médicos.",
    url: "/appointment",
    img: "/assets/img/hero/fondotwo.jpeg",
  },
  {
    id: 2,
    title: "UMSA y UPEA: La Carrera de Medicina Frente a Frente",
    maintitle: "Oferta",
    desp: "Un análisis de los programas de Medicina en ambas universidades, destacando los recursos, prácticas clínicas y especialidades disponibles para los estudiantes interesados en el campo de la salud.",
    url: "/appointment",
    img: "/assets/img/hero/fondofour.jpeg",
  },
  {
    id: 3,
    title: "Estudiar Medicina en La Paz: UMSA o UPEA",
    maintitle: "Decisión",
    desp: "Descubre cuál de estas dos universidades ofrece mejores oportunidades para tu formación médica. Analizamos desde las instalaciones hasta las pasantías y redes de apoyo profesional.",
    url: "/appointment",
    img: "/assets/img/hero/fondosfive.jpeg",
  },
  {
    id: 4,
    title: "Medicina en la UMSA vs. UPEA: ¿Qué Universidad Te Conviene?",
    maintitle: "Eleccion",
    desp: "Una comparativa detallada sobre lo que las facultades de Medicina de la UMSA y la UPEA tienen para ofrecer, desde la experiencia en hospitales hasta las posibilidades de especialización y crecimiento profesional.",
    url: "/appointment",
    img: "/assets/img/hero/fondosix.jpeg",
  },
];
                ...
                <div className="hero-slider-info">
                  <div className="slider-info">
                    ...
                    <div data-swiper-parallax="300">
                      <ButtonCommon to={item.url}>Ver Mas</ButtonCommon>
                    </div>
                  </div>
                </div>
              </div>
